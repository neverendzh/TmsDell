      ...
      <aside>
		...
		<form class="form-horizontal" action="/card/destory/now" method="GET">
            <div class="form-group has-default has-feedback">
             ...
             <div class="form-group has-default has-feedback">
                <label class="control-label col-sm-3" for="inputSuccess3">有效期</label>
                <div class="col-sm-9">
                <input type="text" readonly class="form-control" id="inputSuccess3" aria-describedby="inputSuccess3Status" value="2017-12-12" name="endTime">
                </div>
            </div>
              <div class="form-group has-default has-feedback">
                <label class="control-label col-sm-3" for="inputSuccess3">开始日期</label>
                <div class="col-sm-9">
                <input type="text" readonly class="form-control" id="inputSuccess3" aria-describedby="inputSuccess3Status" value="2015-13-12" name="CreatTime">
             </div>
            </div>

             <div class="form-group has-default has-feedback">
                <label class="control-label col-sm-3" for="inputSuccess3">剩余天数</label>
                <div class="col-sm-9">
                <input type="text" readonly class="form-control" id="inputSuccess3" aria-describedby="inputSuccess3Status" value="30" name="dataNumber">
            </div>
            </div>
            ...
            <div class="form-group has-default has-feedback">
                ...
                <div class="col-sm-9">
                <input type="text" readonly class="form-control" id="inputSuccess3" aria-describedby="inputSuccess3Status" value="正常" name="state">
            </div>
            </div>
        </form>
        <br>
            <div class="form-group has-default has-feedback">
                ...
                <div class="col-sm-9">
                 <button type="button" class="btn btn-primary btn-lg" id="dongjie">冻结</button>
            </div>
            </div>
