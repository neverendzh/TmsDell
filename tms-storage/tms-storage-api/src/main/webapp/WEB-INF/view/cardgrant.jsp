...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		...
		<form class="form-horizontal" id="sellCardForm" action="/card/sell" method="POST">
            <div class="form-group has-default has-feedback">
                <label class="control-label col-sm-3" for="inputSuccess3" >购票地址</label>
                <div class="col-sm-9">
            ...
            <div class="form-group has-default has-feedback">
                ...
                <div class="col-sm-9">
                    <input type="text" readonly class="form-control"  aria-describedby="inputSuccess3Status" value="${shop.name}" name="nameSell">
                </div>
            </div>
             <div class="form-group has-default has-feedback">
                <label class="control-label col-sm-3" for="inputSuccess3">购票人姓名</label>
                <div class="col-sm-9">
                <input type="text" readonly class="form-control" id="inputSuccess4" aria-describedby="inputSuccess3Status" value="${shop.shopAccount.spare}" name="name">
                </div>
            </div>
              <div class="form-group has-default has-feedback">
                <label class="control-label col-sm-3" for="inputSuccess3">购票人手机号</label>
                <div class="col-sm-9">
                <input type="text" readonly class="form-control" id="inputSuccess5" aria-describedby="inputSuccess3Status" value="${shop.shopAccount.account}" name="phone">
             </div>
            </div>
            ...
            <div class="form-group has-default has-feedback">
             ...
             <div class="form-group has-default has-feedback">
                ...
                <div class="col-sm-9">
                <input type="text"  class="form-control" id="inputSuccess7" aria-describedby="inputSuccess3Status" value="${cardSell}" name="numbersell">
            </div>
            </div>
        ...
        <br>
            <div class="form-group has-default has-feedback">
                ...
                <div class="col-sm-9">
                 <button type="button" class="btn btn-primary btn-lg" id="sellCard">确认下发</button>
            </div>
            </div>
